...
Examples:
./plot_2d.py -m ExtrabQuarksInTT_StdSelections_TopCut100_AllSelections_NoTrgMatch__H2Cut0p5_NoTopMassCut_170831_085353/ --url -i "M_500"
...
# kchristo +++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    elif "DiJet_BJet_dR_Vs_Top_Pt" in h:
        kwargs["xmax"] = 5.0
        kwargs["ymax"] = 1000.0
        kwargs["zmin"] = 1e-1
        kwargs["zmax"] = 1e+4
    ...
    elif "GenW_Bq_dR_Vs_GenTop_Pt" in h:
        kwargs["xmax"] = 5.0
        kwargs["ymax"] = 1000.0
        kwargs["zmin"] = 1e-1
        kwargs["zmax"] = 1e+4
        ...
        # --- Boosted Topologies-----------------------------------------
    elif "Iffatjet_Hs_Top_pT_Vs_W_pT" in h:
        kwargs["xmax"] = 1000.0
        kwargs["ymax"] = 1000.0
        kwargs["zmin"] = 1e-1
        kwargs["zmax"] = 1e+3
        ...
        # -----TTsample----------------------------------------------------------------------------------------                                                                  
    elif "bfromH_as_extrab_ldgtop_dR_Vs_subldgtop_extrab_dR" in h:
        kwargs["xmax"] = 5.0
        kwargs["ymax"] = 5.0
        kwargs["zmin"] = 1e-1
        kwargs["zmax"] = 3e+2
    ...
    elif "quark_pT_Vs_jet_pT_intodR" in h:
        kwargs["xmax"] = 25.0
        kwargs["ymax"] = 250.0
        kwargs["zmin"] = 1e-1
        kwargs["zmax"] = 1e+4
        ...
        # ++++++ Soft b-jet analysis
    elif "Associated_bquark_Eta_Vs_Pt" in h:
        kwargs["xmax"] = 5.0
        kwargs["ymax"] = 150.0
        kwargs["zmin"] = 1
        kwargs["zmax"] = 5e+2
